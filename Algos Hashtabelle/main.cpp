...
int main() {
	...
	menu.addInput({ "IMPORT", "import", "i"}, Commands::import, "Kurswerte fuer eine Aktie werden aus einer csv Datei iportiert (Namen ohne Dateiendung angeben - csv erwarted)");
